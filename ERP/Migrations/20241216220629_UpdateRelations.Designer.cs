...
namespace ERP.Migrations
{
    ...
    [Migration("20241216220629_UpdateRelations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERP.Models.Veri.IsMerkez.BSMGRNNMWCMOPR", b =>
                {
                    b.Property<string>("WCMDOCNUM")
                        .HasMaxLength(4)
                        .HasColumnType("nvarchar(4)");
                    ...
                    b.ToTable("BSMGRNNMWCMOPR");
                });

            modelBuilder.Entity("ERP.Models.Veri.IsMerkez.BSMGRNNMWCMTEXT", b =>
                {
                    b.Property<string>("WCMDOCNUM")
                        .HasMaxLength(4)
                        .HasColumnType("nvarchar(4)");
            ...
            modelBuilder.Entity("ERP.Models.Veri.Maliyet.BSMGRNNMCCMTEXT", b =>
                {
                    b.Property<string>("CCMDOCNUM")
                        .HasMaxLength(4)
                        .HasColumnType("nvarchar(4)");
            ...
            modelBuilder.Entity("ERP.Models.Veri.Malzeme.BSMGRNNMMATTEXT", b =>
                {
                    b.Property<string>("MATDOCNUM")
                        .HasMaxLength(4)
                        .HasColumnType("nvarchar(4)");
                    ...
                    b.ToTable("BSMGRNNMMATTEXT");
                });

            modelBuilder.Entity("ERP.Models.Veri.Rota.BSMGRNNMROTBOMCONTENT", b =>
                {
                    b.Property<string>("ROTDOCNUM")
                        .HasMaxLength(4)
                        .HasColumnType("nvarchar(4)");
                    ...
                    b.ToTable("BSMGRNNMROTBOMCONTENT");
                });
            ...
            modelBuilder.Entity("ERP.Models.Veri.Rota.BSMGRNNMROTOPRCONTENT", b =>
                {
                    b.Property<string>("ROTDOCNUM")
                        .HasMaxLength(4)
                        .HasColumnType("nvarchar(4)");
                    ...
                    b.ToTable("BSMGRNNMROTOPRCONTENT");
                });

            modelBuilder.Entity("ERP.Models.Veri.UrunAgac.BSMGRNNMBOMCONTENT", b =>
                {
                    b.Property<string>("BOMDOCNUM")
                        .HasMaxLength(4)
                        .HasColumnType("nvarchar(4)");
            ...
            modelBuilder.Entity("ERP.Models.Veri.Rota.BSMGRNNMROTOPRCONTENT", b =>
                {
                    ...
                    b.HasOne("ERP.Models.Veri.IsMerkez.BSMGRNNMWCMHEAD", "FOPRDOCTYPE")
                        .WithMany()
